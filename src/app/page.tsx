...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      {/* Early access — no fake reviews. Replace this block with real
          testimonial cards (see the old git history for the layout) once
          the first few genuine ones come in. */}
      <section className="relative z-10 max-w-3xl mx-auto py-20 px-6 text-center">
        <p className="text-fuchsia-400 text-sm uppercase tracking-[0.3em] mb-4">Early access</p>
        <h2 className="text-4xl font-semibold tracking-tight mb-4">Just launched — be one of the first</h2>
        <p className="text-zinc-400 text-lg mb-8 max-w-xl mx-auto">
          CarouselAI is brand new. No inflated review counts, no fabricated quotes — just try it free and see for yourself.
          If you like it, we&apos;d genuinely love to hear what you think.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <p className="text-zinc-500 text-sm">
            Got feedback? <CopyEmailButton email="hello@aicarousel.tech" label="tell us what you think" />
          </p>
        </div>
      </section>
